...
% bibliography
\usepackage[hyperref=true,backend=biber,style=ieee]{biblatex} % IEEE-style bibliography, biber backend, citation-order sorting
...
\usepackage{colortbl} % colored table cells, for heatmap tables
