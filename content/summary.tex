...
Electric vehicles depend on lithium-ion batteries. Safe and efficient operation requires the Battery Management System to track the battery's State of Health (SoH), which measures the gradual loss of capacity caused by aging. SoH estimation is difficult. Aging is slow and non-linear, and it depends on temperature, load, and usage history.
